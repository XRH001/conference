...
@RestController
public class UserAddConfenceController {
    @Autowired
    ...
    @RequestMapping("/userAddConfence")
    public String UserAddConfenceSelvet(UserAddConfence userAddConfence){
        // 找到该用户
